""" 
Курс математической анимации «Manim для начинающих»
Специально для спонсоров канала Wild Mathing:
https://www.youtube.com/c/WildMathing
https://vk.com/wildmathing
https://boosty.to/wildmathing

СОДЕРЖАНИЕ

— Геометрические фигуры: 1-3, 5-9
— Настройка линий и цвета: 30-35, 38-41
— LaTeX и текст: 12-20, 36-37, 57
— Полезные методы: 23, 42-44, 58, 64
— Положение в кадре: 21-29
— Поворот и гомотетия: 47-48
— Цвет, слои, константы: 26, 45-47
— Анимация: 4, 10, 11, 39-55, 63-64
— Группы объектов: 55-57
— Графики функций: 59-62
— Творческие примеры: 65-76

Туториал по установке: https://vk.com/wall-135395111_27035
Освоение Python, LaTeX: https://vk.com/wall-135395111_27059
Документация: https://docs.manim.community/en/stable/
Подкасты от разработчика: https://vk.com/wall-135395111_27091
Канал Manim в Дискорде: https://discord.com/invite/mMRrZQW
Настройки рендера: https://vk.cc/cep9va
Рендер всех сцен сразу: manim -pqm -a wm_course.py 
Выбор сцены для рендера: manim -pqm wm_course.py 

ManimCE v0.15.1, 2022 год
"""
